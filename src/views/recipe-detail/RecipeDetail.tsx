                    ...
                    <div>
                        ...
                        <ListGroup style={{"paddingTop": "10px"}}>
                            {data?.ingredients.map(
                                (ingredient: any) =>
                                    <ListGroup.Item style={{"paddingTop": "15px", "paddingBottom": "0px", "fontSize": "14px", "fontWeight": 500}}>
                                        <Row>
                                            <Col><p>{ingredient.name}</p></Col>
                                            <Col style={{ "textAlign": "right" }}><p>{ingredient.quantity} {ingredient.unit}</p></Col>
                                        </Row>
                                    </ListGroup.Item>
                            )}
                        </ListGroup>
